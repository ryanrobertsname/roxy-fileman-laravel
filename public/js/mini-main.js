...
RoxyUtils.GetFileIcon = function(path){
  ret = assets_path+'/images/filetypes/unknown.png';//'images/filetypes/file_extension_' + RoxyUtils.GetFileExt(path).toLowerCase() + '.png';
  if(fileTypeIcons[RoxyUtils.GetFileExt(path).toLowerCase()]){
    ret = assets_path+'/images/filetypes/' + fileTypeIcons[RoxyUtils.GetFileExt(path).toLowerCase()];
  }
...
function Directory(fullPath, numDirs, numFiles){
  ...
  this.GetHtml = function(){
     ...
     html += '<div><img src="'+assets_path+'/images/'+(this.dirs > 0?'dir-plus.png':'blank.gif')+'" class="dirPlus" width="9" height="9">';
     html += '<img src="'+assets_path+'/images/folder.png" class="dir"><span class="name">'+this.name+' ('+this.files+')</span></div>';
     html += '</li>';
  ...
  this.Select = function(selectedFile){
    ...
    el.children('img.dir').prop('src', assets_path+'/images/folder.png');
    this.SetStatusBar();
  ...
  this.SetOpened = function(){
    ...
    if(li.find('li').length < 1)
      li.children('div').children('.dirPlus').prop('src', assets_path+'/images/blank.gif');
    else if(this.IsExpanded())
      li.children('div').children('.dirPlus').prop('src', assets_path+'/images/dir-minus.png');
    else
      li.children('div').children('.dirPlus').prop('src', assets_path+'/images/dir-plus.png');
  };
...
function dragFileOver(){
  $(this).children('img.dir').attr('src', assets_path+'/images/folder-green.png');
}
function dragFileOut(){
  $('#pnlDirList').find('img.dir').attr('src', assets_path+'/images/folder.png');
}
...
function makeDragDir(e){
  ...
  return '<div class="pnlDragDir" data-path="'+f.fullPath+'"><img src="'+assets_path+'/images/folder.png" align="absmiddle">&nbsp;'+f.name+'</div>';
}
...
function switchView(t){
  ...
  if(t == 'thumb'){
    $('#pnlFileList .icon').attr('src', assets_path+'/images/blank.gif');
