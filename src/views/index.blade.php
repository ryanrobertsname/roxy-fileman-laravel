...
<link href="{{ $assets_path }}/css/jquery-ui-1.10.4.custom.min.css" rel="stylesheet" type="text/css" />
<link href="{{ $assets_path }}/css/main.min.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
<script type="text/javascript" src="{{ $assets_path }}/js/jquery-ui-1.10.4.custom.min.js"></script>
<script type="text/javascript" src="{{ $assets_path }}/js/custom.js"></script>

<script type="text/javascript">
  var assets_path = '{{ $assets_path }}';
</script>
<script type="text/javascript" src="{{ $assets_path }}/js/directory.js"></script>
<script type="text/javascript" src="{{ $assets_path }}/js/file.js"></script>
<script type="text/javascript" src="{{ $assets_path }}/js/filetypes.js"></script>
<script type="text/javascript" src="{{ $assets_path }}/js/main.js"></script>
<script type="text/javascript" src="{{ $assets_path }}/js/utils.js"></script>

<script type="text/javascript" src="{{ $assets_path }}/js/jquery-dateFormat.min.js"></script>
</head>
<body>
  ...
  <tr>
   <td valign="top" class="pnlDirs" id="dirActions">
    ...
    <div id="pnlLoadingDirs">
       ...
       <img src="{{ $assets_path }}/images/loading.gif" title="Loading directory tree, please wait...">
    </div>
    ...
    <div class="pnlFiles">
       <div class="scrollPane">
         <div id="pnlLoading">
          ...
          <img src="{{ $assets_path }}/images/loading.gif" title="Loading files, please wait...">
          </div>
